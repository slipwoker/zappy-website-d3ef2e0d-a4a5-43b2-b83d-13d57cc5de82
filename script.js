document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateField(field) {
    ...
    if (field.hasAttribute('required') && value === '') {
      ...
      if ((type === 'tel' || name === 'phone' || name === 'tel') && value !== '') {
      ...
      if (field.hasAttribute('minlength')) {
        ...
        if (value.length < min) {
          errorMessage = field.dataset.errorMinlength || ('Minimum ' + min + ' characters required.');
        }
      }
      if (field.hasAttribute('maxlength')) {
        const max = parseInt(field.getAttribute('maxlength'), 10);
        if (value.length > max) {
          errorMessage = field.dataset.errorMaxlength || ('Maximum ' + max + ' characters allowed.');
        }
      }
    }
  ...
  function initScrollAnimations() {
    ...
    elements.forEach(function (el, index) {
      ...
      const delay = el.dataset.animateDelay || (index % 5) * 80;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מקלט אורט 4 משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd3ef2e0d-a4a5-43b2-b83d-13d57cc5de82',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd3ef2e0d-a4a5-43b2-b83d-13d57cc5de82';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd3ef2e0d-a4a5-43b2-b83d-13d57cc5de82';
